...
read
    ...
    bind_profile == local AND profile chosen AND POLICYHR_S2S_TOKEN unset
...
from hr_policy_answers.adapters.local.identity import (
    LocalIdentityAdapter,
)
from hr_policy_answers.adapters.onprem.identity import (
