...
from hr_policy_answers.adapters.gcp.review_router import (
    CloudReviewRouter,
)
from hr_policy_answers.adapters.local.review_router import (
    LocalReviewRouter,
)
from hr_policy_answers.adapters.onprem.review_router import (
    OnPremReviewRouter,
)
