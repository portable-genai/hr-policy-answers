...
const REVIEW_ROUTING_TEXT: Record<string, string> = {
  ...
  failed: "Could not reach the review console; this question is not queued for review.",
  off: "Review routing is off in this deployment; this question is not queued for review.",
};
