# Policy and HR Copilot (H2) serving image.
#
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    POLICYHR_PROFILE=gcp \
    POLICYHR_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "exec uvicorn hr_policy_answers.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
