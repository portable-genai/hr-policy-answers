...
distinct from this service's own inbound ``POLICYHR_S2S_TOKEN``.
...
from .._review_payload import _DEFAULT_ACTION, result_to_review

_SERVICE_ACTOR = "hr-policy-answers"
    ...
    def route(
        ...
        *,
        ...
        review = result_to_review(
            result, maker=maker, tenant=tenant or self._settings.tenant, action=action
        )
